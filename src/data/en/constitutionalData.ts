...
export const CONSTITUTIONAL_VALUES: ConstitutionalValue[] = [
  ...
  },
  {
    ...
    englishTitle: 'Thought, Expression, Movement & Personal Liberty',
    ...
    detailedRelevance: 'Protects the right to question authority, voice dissent, and organise peacefully without fear of retribution, subject to narrowly defined legal limits. It is a right that depends on constant civic vigilance to remain meaningful.',
  ...
  },
  {
    ...
    shortDescription: "Fraternity means recognising every Indian as an equal member of one constitutional family. It is the spirit of common brotherhood that Article 51A(e) calls on every citizen to promote mutual respect and shared responsibility across religion, language, caste, and culture so that India's diversity strengthens, rather than threatens, its unity and integrity.",
    detailedRelevance: 'In a country facing rising communal and caste-based polarization, Fraternity acts as the constitutional check ensuring that democratic freedoms are not weaponized to marginalize or dehumanize any community.',
